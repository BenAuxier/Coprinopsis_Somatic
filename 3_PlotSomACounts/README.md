...
Ran the script and obtained a figure in `results/tree_heatmap.png`. As input it takes the `../2_FindSomAs/results/Loci_counts.txt` file. It also takes the newick tree produced above and a table mapping species to strains (`Sample_Species_map.txt`), both available in the directory `data` here.
